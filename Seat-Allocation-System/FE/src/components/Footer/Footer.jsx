      ...
      <div className="m-10 mt-0 sm:p-10 p-7 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-3 lg:grid-cols-3">
          ...
          <div className="cursor-pointer">
            ...
            <p className="text-gray-500 sm:text-lg sm:text-balance text-justify">
              Welcome to GEE - Gujarat Entrance Exam , your trusted destination for fair and transparent examinations across Gujarat State. Committed to excellence and integrity, we uphold the highest standards in education assessment, ensuring equal opportunities for all. Together, let's pave the way for a brighter future.
            </p>
          </div>
